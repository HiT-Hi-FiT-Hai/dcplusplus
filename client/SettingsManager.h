...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		ADVANCED_RESUME, ADC_DEBUG, TOGGLE_ACTIVE_WINDOW, SEARCH_HISTORY, SET_MINISLOT_SIZE, URL_MAGNET,
		INT_LAST };
...
/**
 * @file
 * $Id: SettingsManager.h,v 1.91 2005/03/12 13:36:33 arnetheduck Exp $
 */
