...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		HUBLIST_SERVERS, QUEUEFRAME_ORDER, QUEUEFRAME_WIDTHS, PUBLICHUBSFRAME_ORDER, PUBLICHUBSFRAME_WIDTHS, STR_LAST };
 ...
 * $Id: SettingsManager.h,v 1.22 2002/03/23 01:58:43 arnetheduck Exp $
 * @if LOG
