...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		DEFAULT_AWAY_MESSAGE, TIME_STAMPS_SET,ADLSEARCHFRAME_ORDER, ADLSEARCHFRAME_WIDTHS, CLIENT_ID,
...
/**
 * @file
 * $Id: SettingsManager.h,v 1.67 2004/08/07 14:38:58 arnetheduck Exp $
 */
