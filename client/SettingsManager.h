...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		ADD_FINISHED_INSTANTLY, SETTINGS_USE_UPNP, DONT_DL_ALREADY_SHARED, SETTINGS_USE_CTRL_FOR_LINE_HISTORY, CONFIRM_HUB_REMOVAL, SETTINGS_OPEN_NEW_WINDOW,
		INT_LAST };
...
/**
 * @file
 * $Id: SettingsManager.h,v 1.77 2004/11/22 00:13:29 arnetheduck Exp $
 */
