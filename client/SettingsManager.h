...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		USERSFRAME_ORDER, USERSFRAME_WIDTHS, HTTP_PROXY, STR_LAST };
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		REMOVE_DUPES, BUFFER_SIZE, DOWNLOAD_SLOTS, MAX_DOWNLOAD_SPEED,
 ...
 * $Id: SettingsManager.h,v 1.23 2002/03/25 22:23:25 arnetheduck Exp $
 * @if LOG
 * $Log: SettingsManager.h,v $
 * Revision 1.23  2002/03/25 22:23:25  arnetheduck
 * Lots of minor updates
 *
 * Revision 1.22  2002/03/23 01:58:43  arnetheduck
 * Work done on favorites...
 *
 * Revision 1.21  2002/03/15 11:59:35  arnetheduck
