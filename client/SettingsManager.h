...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		TAB_HUB_DIRTY, TAB_PM_DIRTY, TAB_SEARCH_DIRTY, SOCKET_IN_BUFFER, SOCKET_OUT_BUFFER, ONLY_DL_TTH_FILES,
		OPEN_WAITING_USERS, WAITING_USERS_DIRTY, OPEN_SYSTEM_LOG, SYSTEM_LOG_DIRTY,
		INT_LAST };
...
/**
 * @file
 * $Id: SettingsManager.h,v 1.105 2005/12/03 20:36:49 arnetheduck Exp $
 */
