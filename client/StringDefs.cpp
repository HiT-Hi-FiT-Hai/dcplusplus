...
"Joins: ", "Join/part showing off", "Join/part showing on", "kB", "Kick user(s)", "A file of equal or larger size already exists at the target location", "Hub (last seen on if offline)", "Low", "Manual connect address", "MB", 
"&File", "&Download Queue\tCtrl+D", "&Exit", "&Favorite Hubs\tCtrl+F", "Favorite &Users\tCtrl+U", "Follow last redirec&t\tCtrl+T", "&Notepad\tCtrl+N", "&Public Hubs\tCtrl+P", "&Reconnect\tCtrl+R", "&Search\tCtrl+S", 
"Search spy", "Settings...", "&Help", "About DC++...", "DC++ discussion forum", "Downloads and translations", "Frequently asked questions", "Help forum", "DC++ Homepage", "Request a feature", 
"Report a bug", "&View", "&Status bar", "&Toolbar", "&Window", "Arrange icons", "Cascade", "Tile", "New...", "Nick", 
"Your nick was already taken, please change to something else!", " (Nick unknown)", "Non-blocking operation still in progress", "Not connected", "Not a socket", "No directory specified", "No slots available", "No users", "No users to download from", "Normal", 
"Offline", "Online", "Only users with free slots", "Operation would block execution", "Out of buffer space", "Password", "Parts: ", "Path", "Paused", "Permission denied", 
"Picture", "Port %d is busy, please choose another one in the settings dialog, or disable any other application that might be using it and restart DC++", "Preparing file list...", "Priority", "Private message from ", "Properties", "Public Hubs", "Really exit?", "Redirect", "Redirect user(s)", 
...
"Search options", "Search Spy", "Search string", "Searching for ", "Send private message", "Server", "Set priority", "Shared", "Size", "Slots", 
"Slots set", "Socket has been shut down", "Specify a server to connect to", "Specify a search string", "Status", "TB", "Timestamps disabled", "Timestamps enabled", "Type", "Unable to create thread", 
...
"Joins", "JoinShowingOff", "JoinShowingOn", "Kb", "KickUser", "LargerTargetFileExists", "LastHub", "Low", "ManualAddress", "Mb", 
"MenuFile", "MenuFileDownloadQueue", "MenuFileExit", "MenuFileFavoriteHubs", "MenuFileFavoriteUsers", "MenuFileFollowRedirect", "MenuFileNotepad", "MenuFilePublicHubs", "MenuFileReconnect", "MenuFileSearch", 
"MenuFileSearchSpy", "MenuFileSettings", "MenuHelp", "MenuHelpAbout", "MenuHelpDiscuss", "MenuHelpDownloads", "MenuHelpFaq", "MenuHelpHelpForum", "MenuHelpHomepage", "MenuHelpRequestFeature", 
"MenuHelpReportBug", "MenuView", "MenuViewStatusBar", "MenuViewToolbar", "MenuWindow", "MenuWindowArrange", "MenuWindowCascade", "MenuWindowTile", "New", "Nick", 
"NickTaken", "NickUnknown", "NonBlockingOperation", "NotConnected", "NotSocket", "NoDirectorySpecified", "NoSlotsAvailable", "NoUsers", "NoUsersToDownloadFrom", "Normal", 
"Offline", "Online", "OnlyFreeSlots", "OperationWouldBlockExecution", "OutOfBufferSpace", "Password", "Parts", "Path", "Paused", "PermissionDenied", 
"Picture", "PortIsBusy", "PreparingFileList", "Priority", "PrivateMessageFrom", "Properties", "PublicHubs", "ReallyExit", "Redirect", "RedirectUser", 
...
"SearchOptions", "SearchSpy", "SearchString", "SearchingFor", "SendPrivateMessage", "Server", "SetPriority", "Shared", "Size", "Slots", 
"SlotsSet", "SocketShutDown", "SpecifyServer", "SpecifySearchString", "Status", "Tb", "TimestampsDisabled", "TimestampsEnabled", "Type", "UnableToCreateThread", 
