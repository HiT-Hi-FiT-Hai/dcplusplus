...
"Donate $$$:s! (well, ï¿½ï¿½ï¿½ preferably =) (see help menu)", 
...
"Upload slots", 
"Register with Windows on startup to handle dchub:// URL links", 
"Register with Windows on startup to handle magnet: URI links", 
