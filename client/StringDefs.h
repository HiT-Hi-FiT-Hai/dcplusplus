...
enum Strings { // @DontAdd
	...
	SETTINGS_EXAMPLE_TEXT, // "Donate $$$:s! (well, ï¿½ï¿½ï¿½ preferably =) (see help menu)"
	...
	SETTINGS_URL_HANDLER, // "Register with Windows on startup to handle dchub:// URL links"
	SETTINGS_URL_MAGNET, // "Register with Windows on startup to handle magnet: URI links"
