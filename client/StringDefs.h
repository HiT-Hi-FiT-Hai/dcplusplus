...
enum Strings { // @DontAdd
	...
	MB, // "MB"
	MENU_FILE, // "&File"
	MENU_FILE_ADL_SEARCH, // "ADL Search"
	...
	MENU_FILE_IMPORT_QUEUE, // "Import queue from NMDC..."
	MENU_FILE_NOTEPAD, // "&Notepad\tCtrl+N"
	MENU_FILE_OPEN_FILE_LIST, // "Open file list..."
	...
	MENU_WINDOW_CLOSE_DISCONNECTED, // "Close disconnected"
	...
	SETTINGS_ADVANCED_ADLS_BREAK_ON_FIRST,  // "Break on first ADLSearch match"
	...
	SETTINGS_ADVANCED_AUTO_SEARCH, // "Automatically search for alternative download locations"
	SETTINGS_ADVANCED_AUTO_UPDATE_LIST, // "Automatically refresh share list every hour"
	SETTINGS_ADVANCED_CLEAR_SEARCH, // "Clear search box after each search"
	SETTINGS_ADVANCED_COMMAND, // "Command"
	SETTINGS_ADVANCED_IGNORE_OFFLINE, // "Ignore messages from users that are not online (effective against bots)"
	SETTINGS_ADVANCED_KEEP_LISTS, // "Don't delete file lists when exiting"
	SETTINGS_ADVANCED_NAME, // "Name"
	SETTINGS_ADVANCED_NO_AWAYMSG_TO_BOTS, // "Don't send the away message to bots"
	SETTINGS_ADVANCED_OPEN_FAVORITE_HUBS, // "Open the favorite hubs window at startup"
	SETTINGS_ADVANCED_OPEN_FINISHED_DOWNLOADS, // "Open the finished downloads window at startup"
	SETTINGS_ADVANCED_OPEN_PUBLIC, // "Open the public hubs window at startup"
	SETTINGS_ADVANCED_OPEN_QUEUE, // "Open the download queue window at startup"
	SETTINGS_ADVANCED_POPUP_OFFLINE, // "Popup messages from users that are not online (if not ignoring, messages go to main chat if enabled)"
	SETTINGS_ADVANCED_POPUP_PMS, // "Popup private messages"
	SETTINGS_ADVANCED_REMOVE_DUPES, // "Remove dupes completely from your share (otherwise, only their size is subtracted, but the files can be seen by others)"
	SETTINGS_ADVANCED_SFV_CHECK, // "Enable automatic SFV checking"
	SETTINGS_ADVANCED_SHOW_PROGRESS_BARS, // "Show progress bars for transfers (uses some CPU)"
	SETTINGS_ADVANCED_SKIP_ZERO_BYTE, // "Skip zero-byte files"
	SETTINGS_ADVANCED_SMALL_SEND_BUFFER, // "Use small send buffer (enable if uploads slow downloads a lot)"
	SETTINGS_ADVANCED_TAB_COMPLETION, // "Tab completion of nicks in chat"
	SETTINGS_ADVANCED_URL_HANDLER, // "Install URL handler on startup (to handle dchub:// links)"
	SETTINGS_APPEARANCE, // "Appearance"
	SETTINGS_APPEARANCE_FINISHED_DIRTY, // "Set Finished Manager(s) tab bold when an entry is added"
	SETTINGS_APPEARANCE_FULL_ROW_SELECT, // "Full row select in lists"
	SETTINGS_APPEARANCE_FILTER_MESSAGES, // "Filter kick and NMDC debug messages"
	SETTINGS_APPEARANCE_MINIMIZE_TRAY, // "Minimize to tray"
	SETTINGS_APPEARANCE_TIME_STAMPS, // "Show timestamps in chat by default"
	SETTINGS_APPEARANCE_CONFIRM_EXIT, // "Confirm application exit"
	SETTINGS_APPEARANCE_STATUS_IN_CHAT, // "View status messages in main chat"
	SETTINGS_APPEARANCE_SHOW_JOINS, // "Show joins / parts in chat by default"
	SETTINGS_APPEARANCE_USE_SYSTEM_ICONS, // "Use system icons when browsing files (slows browsing down a bit)"
